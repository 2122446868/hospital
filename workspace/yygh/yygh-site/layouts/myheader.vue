    ...
    <div class="wrapper">
      ...
      <div class="right-wrapper">
        ...
                <span v-if="name == ''"
          ...
          @click="dialogUserFormVisible = true" id="loginDialog">登录/注册</span>
  ...
  methods: {
    ...
    btnClick() {
      ...
      if (this.dialogAtrr.loginBtn == "获取验证码") {
        ...
        // 登录
        console.log("this.login();111111111111111111111");
        this.login();
      }
    }, // 绑定登录，点击显示登录层
    showLogin() {
    ...
    login() {
      console.log("login11111111111111111执行了");
      ...
      console.log("login22222222执行了");
      userInfoApi
        .login(this.userInfo)
        .then((response) => {
          console.log("login+data：" + response.data); // 登录成功 设置cookie
