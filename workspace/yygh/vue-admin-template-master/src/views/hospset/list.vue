<template>
  <div class="app-container">
    <el-form :inline="true" class="demo-form-inline">
         <el-form-item>
              <el-input v-model="serachObj.hosname" placeholder="医院名称" />
           </el-form-item
      >
         <el-form-item>
           <el-input v-model="serachObj.hoscode" placeholder="医院编号" />
           </el-form-item
      >
         <el-button type="primary" icon="el-icon-search" @click="getList()"
        >查询</el-button
      >
      <el-button @click="restDate()">重置</el-button>
      <el-button @click="hrefAdd" type="primary" style="float: right"
        >添加</el-button
      >
...
export default {
  ...
  methods: {
    ...
    getList(page = 1) {
      this.current = page;
      hospset
        .getHospSetfList(this.current, this.limit, this.serachObj)
        .then((response) => {
