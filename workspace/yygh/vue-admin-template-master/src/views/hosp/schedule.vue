...
                            </template>
                        </el-table-column>
                        <el-table-column label="职称" width="350">
                            <template slot-scope="scope">
                                            {{ scope.row.title }} | {{ scope.row.docname }}
                            </template>
                        </el-table-column>
                        <el-table-column label="号源时间" width="280">
                            <template slot-scope="scope">
...
        fetchData() {
            hospApi.getDepartList(this.hoscode)
                .then(response => {
...
.el-checkbox_input.is-checked + .el-checkbox_label {
  color: black;
}
</style>
