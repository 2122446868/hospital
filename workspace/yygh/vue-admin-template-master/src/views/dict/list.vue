  ...
  <div class="app-container">
    <div class="el-toolbar">
      <div class="el-toolbar-body" style="justify-content: flex-start">
        <a
          href="http://localhost:8202/admin/cmn/dict/exportDictData"
          target="_blank"
        >
...
export default {
  ...
  created() {
    this.findByParentId(1);
  },
  methods: {
    //   全部的字典数据
    findByParentId(id) {
      dict.findByParentId(id).then((response) => {
    ...
    getChildrens(tree, treeNode, resolve) {
      dict.findByParentId(tree.id).then((response) => {
